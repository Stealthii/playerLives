...
public class EconWrapper {
	...
	return Double.toString(amount) + " " + getCurrency(amount);
    }
    ...
    public void subBalance(Player player, double value) {
	subBalance(player.getName(), value);
    }

    public String getCurrency(boolean multi) {
	return multi ? "Coins" : "Coin";
    }

    public String getCurrency(double value) {
	return getCurrency(value > 1.0);
    }
